...
data = NoisySet{2};
%convex
[C, tau, error] = find_tau(data,tau_range,'noise convex',num,c);
tau
error
figure;
scatter(1:n*c,C);
...
%non-convex
[C, tau, error] = find_tau(data,tau_range,'noise nonconvex',num,c);
tau
error
figure;
scatter(1:n*c,C);
...
[C, tau, error] = find_tau(data,tau_range,'uncorrupt',num,c);
tau
error
figure;
scatter(1:n*c,C);
